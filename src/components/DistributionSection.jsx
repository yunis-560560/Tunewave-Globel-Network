        ...
        <div className="a3-logo-marquee-section reveal-up">
          ...
          <div className="a3-logo-marquee-mask">
            <div className="a3-logo-track">
              {[
                { name: "Deezer", src: "/platformlogos/Deezer.png" },
                { name: "Apple Music", src: "/platformlogos/applemusic.png" },
                { name: "Instagram", src: "/platformlogos/instagram.png" },
                { name: "JioSaavn", src: "/platformlogos/jiosaavan.png" },
                { name: "Gaana", src: "/platformlogos/gaana.png" },
                { name: "TikTok", src: "/platformlogos/Tiktok.png" },
                { name: "150+ Stores", src: "/platformlogos/150plus.png" },
                { name: "Spotify", src: "/platformlogos/Spotify.png" },
                { name: "YouTube Music", src: "/platformlogos/youtube.png" },
                { name: "Deezer", src: "/platformlogos/Deezer.png" },
                { name: "Apple Music", src: "/platformlogos/applemusic.png" },
                { name: "Instagram", src: "/platformlogos/instagram.png" },
                { name: "JioSaavn", src: "/platformlogos/jiosaavan.png" },
