...
export default function LoginPage({ 
  ...
  const bgImageUrl = isLight 
    ? '/login_background_image/light_mode.png' 
    : '/login_background_image/Dark_mode.png';
  ...
  return (
    <div style={{
      ...
      {/* Atmosphere Contrast Tint */}
      <div style={{
        position: 'absolute',
        inset: 0,
        background: isLight 
          ? 'radial-gradient(ellipse at center, rgba(255, 255, 255, 0.2) 0%, rgba(248, 250, 252, 0.45) 100%)' 
